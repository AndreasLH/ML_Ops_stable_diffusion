...
def test_dataloader():
    ...
    assert batch.shape == (64, 3, 128, 128), "Batch does not have the expected shape (64, 3, 128, 128)"
    assert batch.dtype == torch.float32, "Batch does not have expected dtype, torch.float32"
